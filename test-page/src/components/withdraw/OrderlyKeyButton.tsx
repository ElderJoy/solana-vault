...
import { bigIntReplacer, CommonProps } from '../common';
...
export const OrderlyKeyButton: FC<CommonProps> = (props) => {
    ...
    const doOrderlyKey = async (orderlyKeyBody: OrderlyKeyBody) => {
        const requestBody = JSON.stringify(orderlyKeyBody, bigIntReplacer);
    ...
    const orderlyKey = async () => {
        try {
            ...
            await doOrderlyKey(orderlyKeyBody);
